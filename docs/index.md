...
你好，我是XXX，我做过toB的权限管控，做过toC的打车服务，也做过区块链的项目。我最近在openblock主导的重构对账方案，将对账复杂度从O(n)优化到O(logn)。现在主要使用Go开发，熟悉MySQL、Redis、Kafka、HTTPS等网络协议，也熟悉Agent的开发。具备较好的产品思维，GitHub开源项目累计获得3.9k Stars。
